...
* TA: Michelle Nguyen
* This program takes in text or textfile as an input and
* looks for the longest palindromes. In case there are
* many palindromes of the same size, it use the first
* one.
*/
